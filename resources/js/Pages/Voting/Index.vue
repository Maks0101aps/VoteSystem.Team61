  ...
  <div class="relative min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-8">
    ...
    <div class="container mx-auto px-4 relative z-10 max-w-4xl">
      ...
      <div class="text-center mb-10">
        <h1 class="text-4xl font-bold text-green-800 mb-2">Голосування</h1>
        <div class="h-1 w-24 bg-green-500 mx-auto mb-4 rounded-full"></div>
        <p class="text-xl text-green-700">Активні голосування</p>
      </div>
      ...
      <div class="space-y-6">
        <div v-if="!votings || votings.length === 0" class="bg-white p-8 rounded-xl shadow-md backdrop-blur-sm bg-opacity-90 text-center">
          ...
          <h3 class="text-xl font-medium text-green-700 mb-2">Немає активних голосувань</h3>
          <p class="text-green-600 mb-6">Будьте першим, хто створить голосування.</p>
